...
export type GreetInstruction<
  TProgram extends string = typeof EVENT_MARKETPLACE_PROGRAM_ADDRESS,
...
export function getGreetInstruction<
  TProgramAddress extends Address = typeof EVENT_MARKETPLACE_PROGRAM_ADDRESS,
>(config?: {
  programAddress?: TProgramAddress;
}): GreetInstruction<TProgramAddress> {
  // Program address.
  const programAddress = config?.programAddress ?? EVENT_MARKETPLACE_PROGRAM_ADDRESS;
